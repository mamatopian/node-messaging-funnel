...
var Base = module.exports = function(){
    ...
    this.sendMessage = function(to, message){ console.log('Method not implemented (send message)'); return message;};
    ...
    this.emitters = {
        ...
        error : function(err){ console.log(err); that.emit('error', err); }
    };
};
